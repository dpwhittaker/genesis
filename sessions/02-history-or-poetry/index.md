...
> — [Pirkei Avot 5:1](texts/pirkei-avot-5.md) (trans. J. Kulp, CC BY)

Notice what the rabbis are doing. They are **counting**. Read Genesis 1 and tally the times "**And God said**" issues a command — there are nine; add the opening "**In the beginning**," which the tradition also counts as an utterance, and you get **ten**. The sages are not reading Genesis as a flat chronicle to be checked against a stopwatch. They are reading it as a *deliberately patterned, counted composition* — and they say the very number of its words upholds the world.

And they keep counting. The whole of *Pirkei Avot* 5 is a cascade of numbered lists: **ten** utterances of creation, **ten** generations from Adam to Noah, **ten** from Noah to Abraham, **ten** trials of Abraham, **ten** plagues, **ten** wonders at the sea, **ten** things made at the first Sabbath's twilight — then **sevens**, then **fours**. The two numbers that run through their meditation, **ten** and **seven**, are exactly the two numbers built into Genesis 1: ten utterances, seven days. (More excerpts: **[Pirkei Avot 5](texts/pirkei-avot-5.md)**.)
...
| **Day 3** — dry land & plants | → | **Day 6** — land animals & humankind |
| | | **Day 7** — God rests |
{: .ff-table}
...
- **Genesis 1:1 is exactly seven words; 1:2 is fourteen** (7 × 2).
- The **whole account, Genesis 1:1–2:3, runs 469 words — 7 × 67.**
- "**And God saw that it was good**" falls **seven** times; "**God**" (*Elohim*) **35** times (7 × 5); "**the earth**" (*ʾereṣ*) **21** times (7 × 3).
- The closing paragraph on the seventh day (2:1–3) has **35** words (7 × 5), and its three clauses that name the day each hold exactly **seven** words — "**the seventh day**" inside each one.

And the author plainly *works* to hold the count, choosing the fuller wording where a shorter one would have done:

- **The double *ʾēt* in 1:1.** Hebrew marks a definite object with the little word *ʾēt*, which elevated style often drops. Genesis keeps it **twice** — "*ʾēt* the heavens *and ʾēt* the earth" — and the verse lands on exactly **seven** words. Drop the two markers, as the grammar allows, and only five remain.
- **"God" thirty-five times, never "he."** A Hebrew verb already carries its subject, so "and he said… and he saw" would read perfectly. Instead *Elohim* is named again and again — **35 = 7 × 5** — spending a noun wherever a pronoun would do.
- **Three sevens for one Sabbath.** The point of 2:2–3 could be made in a single line; instead it is spread into **three measured seven-word clauses** — God *finished*… on the seventh day; *rested*… on the seventh day; *blessed*… the seventh day.
...
Put the panels inside their frame and the full shape appears. Genesis 1:1–2:3 is a **chiasm** — a structure that mirrors itself around a center (the name comes from the Greek letter *chi*, **Χ**, whose two arms cross). The outer envelope folds back on itself, the six days run as the two matched panels, and the whole composition **turns on a hinge in the middle** and **comes to rest at the end**.
...
<span class="lbl">A · Introduction — Genesis 1:1 · 7 Hebrew words</span>
<p class="scripture">In the beginning God created the heaven and the earth.</p>
<p class="chiasm-note"><b>Exactly seven Hebrew words.</b> "Heaven and earth" is a merism — a way of saying <i>everything</i>. The whole poem will now take this raw "everything" and give it shape and life.</p>
</div>
...
<p class="scripture"><span class="v">26</span>And God said: 'Let us make man in our image, after our likeness; and let them have dominion over the fish of the sea, and over the fowl of the air, and over the cattle, and over all the earth, and over every creeping thing that creepeth upon the earth.'</p>
<div class="chiasm-poem">
<span class="pl"><span class="v">27</span>And God created man in His own image,</span>
<span class="pl">in the image of God created He him;</span>
<span class="pl">male and female created He them.</span>
</div>
<p class="scripture"><span class="v">28</span>And God blessed them; and God said unto them: 'Be fruitful, and multiply, and replenish the earth, and subdue it; and have dominion over the fish of the sea, and over the fowl of the air, and over every living thing that creepeth upon the earth.' <span class="v">29</span>And God said: 'Behold, I have given you every herb yielding seed, which is upon the face of all the earth, and every tree, in which is the fruit of a tree yielding seed—to you it shall be for food; <span class="v">30</span>and to every beast of the earth, and to every fowl of the air, and to every thing that creepeth upon the earth, wherein there is a living soul, [I have given] every green herb for food.' And it was so. <span class="v">31</span>And God saw every thing that He had made, and, behold, it was very good. And there was evening and there was morning, the sixth day.</p>
<p class="chiasm-note"><b>Here the pattern breaks — on purpose.</b> Humankind is no mere item in the filling; it is a <b>117-word climax heaped on top of Day 6</b>, overflowing the measured hill (that is why the box sits outside the others). And the overflow keeps a shape of its own: at its heart, <b>verse 27 is the first poetry in the Bible</b> — three lines, each closing on the verb <i>bārāʾ</i>, "created" (<b>3×</b>), folding around their center, <b>the image of God</b> (<i>image</i>, <i>ṣelem</i>, <b>3×</b> in two verses). The account that has marched in measured prose breaks into <i>song</i> exactly where it reaches the creature made in God's image.</p>
</div>
...
<span class="lbl">A′ · The destination — Genesis 2:2–3 · 30 words</span>
<p class="scripture"><span class="v">2</span>And on the seventh day God finished His work which He had made; and He rested on the seventh day from all His work which He had made. <span class="v">3</span>And God blessed the seventh day, and hallowed it; because that in it He rested from all His work which God in creating had made.</p>
<p class="chiasm-note">The mirror of <b>A</b> — "the heaven and the earth" sound again — but now the bare "everything" of 1:1 has become a finished world brought to its goal: a day God <b>blessed</b> and <b>made holy</b>. The poem that centers on sacred time <i>ends</i> on the first holy time. <b>This is what the whole structure was built to arrive at: rest.</b></p>
</div>
...
It is tempting to hear that question as a trap — as if calling Genesis 1 "poetry" were a polite way of calling it untrue. But that is a modern reflex, not an ancient one. In the world this text came from, the **highest** truths were carried in the **most ordered** language, not the plainest. A royal monument, a temple dedication, a creation account — these were composed as art *because* they mattered, not in spite of it.
...
*Scripture: Genesis 1:1–2:3, Jewish Publication Society 1917 (public domain). Pirkei Avot 5:1 trans. Dr. Joshua Kulp (CC BY), via Sefaria. Numerical observations after U. Cassuto, A Commentary on the Book of Genesis.*
{: .no-print}
